...
window.WOT_NPC_RULES = {
  asiLevels: {
    ...
    'Дичок':[4,8,12,16,19],
    'Носитель Договора':[4,8,12,16,19],
  ...
  nationBonuses: {
    ...
    'Агори':{wis:1,con:1}, 'Тишани':{int:2}, 'Харани':{dex:1,con:1}, 'Кайнар':{str:1,con:1}
  },
  equipment: {
    weapons: [
  ...
  legacyHierarchies: {
    ...
    guild:{name:'Гильдия Хранителей Фар Мэддинга',type:'guild',color:'#7ae8d4',priority:['int','wis'],ranks:{
      I:{statPenalty:2,speed:0,initiative:-1,saves:-1,items:[['Кадет Хранителей','Первичная адаптация: −1 к двум различным характеристикам; инициатива −1; −1 ко всем спасброскам. Штрафы прекращаются при получении II ранга.']]},
      II:{stats:{int:2,wis:2},hp:10,speed:10,initiative:2,saves:1,items:[['Офицер-Хранитель','Новый пакет +2 к двум выбранным характеристикам, предел 20; максимум хитов +10; регенерация 3.']]},
      III:{stats:{int:2,wis:2},hp:20,speed:15,initiative:5,saves:2,saveAdv:'ИНТ/МДР',items:[['Инженер-Хранитель','Новый пакет +2/+2, предел 20; фиксированный бонус к максимуму хитов теперь +30 всего; регенерация 5; преимущество на все спасброски Интеллекта и Мудрости.'],['Тактическое превосходство','1/раунд: переставить инициативу двух видимых существ в начале раунда или реакцией после хода союзника дать ему перемещение до половины скорости без расхода его реакции.'],['Защита Хранителя','Бонусное действие, 1/день, концентрация до 1 минуты: радиус 10 фт; автоподавление плетений 1-го уровня и ниже; для более высоких — проверка Интеллекта с помехой против СЛ 12.']]},
      IV:{stats:{int:2,wis:2},hp:20,ac:2,speed:20,initiativeAdv:true,saves:3,items:[['Советник Гильдии','Новый пакет +2/+2, предел 22; фиксированный бонус к максимуму хитов +50 всего; регенерация 10.'],['Энергетический щит','Пассив: +2 КД против всех бросков атаки и сопротивление урону, непосредственно причинённому плетениями Единой Силы.'],['Адаптация к аномалиям','Иммунитет к постоянным фоновым отрицательным эффектам аномальной среды; преимущество на спасброски против эффектов аномалий и плетений; Перенаправление всплеска 1/продолжительный отдых.']]},
      V:{stats:{int:2,wis:2},hitDiceMult:3,speed:30,initiative:10,initiativeAdv:true,saves:5,cap:24,items:[['Главный Хранитель','Новый пакет +2/+2, предел 24; +50 хитов всего сохраняется; вклад классовых Hit Dice в максимум хитов ×3; регенерация 15.'],['Владыка Стража','Высший интерфейс с известными системами Гильдии и Стража. Управление доступом и Полное подавление — отдельные 60-футовые режимы, каждый 1/продолжительный отдых, до 1 минуты без концентрации.'],['Мастер хитрости','Реакция 1/раунд, когда видимый враг начинает действие: союзник немедленно совершает одну атаку оружием по этому врагу без расхода своей реакции.']]}
    }},
