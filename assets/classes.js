...
(function(){
  ...
  const classBlurbs = {
    ...
    'Варвар': 'Первобытная ярость, безрассудный натиск, стойкость к физическому урону и путь берсерка.',
    'Воин': 'Классический боевой класс D&D 5e: боевые стили, Второе дыхание, Всплеск действий, архетипы Чемпиона и Мастера боевых искусств.',
